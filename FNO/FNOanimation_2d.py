...
class FNO_architecture_2d(ThreeDScene):
    def construct(self):
        ...
        #### create the tensor
        tensor_size = (d_input, n_points, n_points)  # tensor size
        ...
        self.play(
            ...
            tensor_group1.animate.move_to(LEFT),
            run_time=1,
        )
        self.wait(1)
        ...
        tensor_size = (d_input + 2, n_points, n_points)
        ...
        self.play(
            ReplacementTransform(
                Group(tensor_group1, tensor_group2, tensor_group3), tensor_group_input
            ),
            run_time=1,
        )
        etichetta1 = MathTex(
            r"v_0(\mathbf{x}) = (a(\mathbf{x}), \mathbf{x})", font_size=etichette_font
        )
        ...
        #### text
        text3 = MathTex(
            r"\text{Apply lifting operator } \mathcal{P}", font_size=text_font
        )
        text3.to_edge(RIGHT)
        ...
        self.play(
            ...
            etichetta1.animate.shift(2 * LEFT),
            tensor_group_input.animate.shift(2 * LEFT),
        ...
        for i in range(1, tensor_size[0] + 1):
            specific_cube = tensor_group_input[
                6 * 6 * i - 1
            ]  # Change this index to target a different cube
        ...
        label1 = MathTex(
            r"W_{\mathcal{P}} v_0(x_{1, 1}) + b_{\mathcal{P}}", font_size=label_font_big
        )
        label2 = MathTex(
            r"W_{\mathcal{P}} \in \mathbb{R}^{d_a \times d_v},\ b_{\mathcal{P}} \in \mathbb{R}^{d_v}",
        ...
        for i in range(1, tensor_size[0] + 1):
            ...
            if i == tensor_size[0]:
                ...
                label1_2 = MathTex(
                    r"W_{\mathcal{P}} v_0(x_{1, 2}) + b_{\mathcal{P}}",
                    font_size=label_font_big,
                )
                label1_2.next_to(arrow, UP, buff=0.2)
                self.play(
                    specific_cube.animate.set_color(RED),
                    ReplacementTransform(label1, label1_2),
                    run_time=1,
                )
        ...
        tensor_group_W = self.createTensor(
            (d_v, n_points, n_points), length, spacing, color=BLUE
        )
        ...
        for i in range(1, tensor_size[0] + 1):
            ...
            self.play(specific_cube.animate.set_color(BLUE), run_time=0.4)
        self.play(
            ReplacementTransform(tensor_group_W1, tensor_group_W),
            FadeOut(tensor_group_W2),
            run_time=1,
        )
        ...
        text4 = Tex(
            r"Apply an affine and \\ pointwise transformation", font_size=text_font
        )
        text4.to_edge(RIGHT)
        title2 = Text("FIRST FOURIER LAYER (L=1)", font_size=title_font)
        title2.to_edge(UP)
        self.play(
            tensor_group_W.animate.move_to(4 * LEFT),
            etichetta2.animate.shift(6 * LEFT),
        ...
        tensor_group_V1 = self.createTensor(
            (d_v, n_points, n_points), length, spacing, color=GREEN
        )
        ...
        label2 = MathTex(
            r"W_1 \in \mathbb{R}^{d_v \times d_v}, b_1 \in \mathbb{R}^{d_v}",
            font_size=label_font_small,
        )
        label1.next_to(arrow, UP, buff=0.2)
        label2.next_to(arrow, DOWN, buff=0.2)
        ...
        self.play(
            ...
            FadeOut(label1),
            FadeOut(label2),
            tensor_group_V1.animate.to_corner(DR).scale(1 / 3),
            FadeOut(etichetta3),
            run_time=1,
        )
        ...
        #### FNO block
        text5 = MathTex(
            r"\text{The input represent} \\ \text{a function in } \mathbb{R}^{d_v}",
            font_size=text_font,
        )
        text5.to_edge(RIGHT)
        ...
        text7 = MathTex(
            r"\text{Apply the}\\ \text{Fourier transform}", font_size=text_font
        )
        text7.to_edge(RIGHT)
        ...
        # Fourier transform
        tensor_group_F = self.createTensor(
            (d_v, k_max, k_max), length, spacing, color=BLUE
        )
        tensor_group_F.scale(0.5)
        tensor_group_F.move_to(2 * RIGHT)
        etichetta4 = MathTex(
            r"\hat{\mathbf{v}}_{1}(\mathbf{k})", font_size=etichette_font
        )
        ...
        self.play(
            ...
            etichetta4.animate.shift(6 * LEFT),
            tensor_group_F.animate.move_to(4 * LEFT),
            run_time=1,
        )

        # Parameters multiplication
        tensor_group_F_theta = self.createTensor(
            (d_v, k_max, k_max), length, spacing, color=RED
        )
        tensor_group_F_theta.scale(0.5)
        tensor_group_F_theta.move_to(2 * RIGHT)
        etichetta5 = MathTex(
            r"\hat{\mathbf{v}}_{2}^{glob}(\mathbf{k})", font_size=etichette_font
        )
        ...
        self.play(GrowArrow(arrow))
        label = MathTex(
            r"R_{\Theta, t} \in \mathbb{C}^{d_v \times d_v \times k_{max} \times k_{max}}",
            font_size=label_font_small,
        )
        label.next_to(arrow, UP, buff=0.2)
        self.play(FadeIn(label), run_time=1)
        ...
        text9 = MathTex(
            r"\hat{\mathbf{v}}_{2}^{glob}(\mathbf{k}) = R_{\Theta, 1}(\mathbf{k}) \hat{\mathbf{v}}_{1}(\mathbf{k}) \\ \forall \mathbf{k} \in \mathbb{Z}_{k_{max}}",
            font_size=text_font,
        )
        text9.to_edge(RIGHT)
        ...
        self.play(
            FadeOut(arrow),
            FadeOut(label),
            FadeOut(tensor_group_F),
            FadeOut(etichetta4),
            run_time=1,
        )
        self.play(
            tensor_group_F_theta.animate.move_to(4 * LEFT),
            etichetta5.animate.shift(6 * LEFT),
            run_time=1,
        )
        self.wait(1)
        ...
        tensor_group_F_1 = self.createTensor(
            (d_v, n_points, n_points), length, spacing, color=RED
        )
        tensor_group_F_1.scale(0.5)
        tensor_group_F_1.move_to(2 * RIGHT)
        etichetta6 = MathTex(r"v_2^{glob}(\mathbf{x})", font_size=etichette_font)
        ...
        self.play(
            FadeOut(arrow),
            FadeOut(label),
            FadeOut(tensor_group_F_theta),
            FadeOut(etichetta5),
            FadeOut(text10),
            run_time=1,
        )
        self.play(
            tensor_group_F_1.animate.move_to(4 * LEFT),
            etichetta6.animate.shift(6 * LEFT),
            run_time=1,
        )
        ...
        etichetta7 = MathTex(r"v_2(\mathbf{x})", font_size=etichette_font)
        ...
        self.play(
            ...
            FadeOut(equal),
            FadeOut(plus),
            FadeOut(tensor_group_F_1),
            FadeOut(etichetta6),
            FadeOut(tensor_group_V1),
            FadeOut(etichetta3),
            FadeOut(text11),
            run_time=1,
        )
        etichetta8 = MathTex(r"v_L(\mathbf{x})", font_size=etichette_font)
        ...
        self.play(
            ...
            ReplacementTransform(etichetta7, etichetta8),
            run_time=1,
        )
        self.play(
            tensor_group_V.animate.move_to(4 * LEFT),
            etichetta8.animate.shift(7 * LEFT),
            run_time=1,
        )
        text12 = MathTex(
            r"\text{Apply the projection operator } \mathcal{Q}", font_size=text_font
        )
        ...
        tensor_group_output = self.createTensor(
            (d_output, n_points, n_points), length, spacing, color=BLUE
        )
        tensor_group_output.move_to(2 * RIGHT).scale(0.5)
        etichetta9 = MathTex(r"u(\mathbf{x})", font_size=etichette_font)
        ...
        # create a label above the arrow
        label1 = MathTex(
            r"W_{\mathcal{Q}} v_L(\mathbf{x}) + b_{\mathcal{Q}}",
            font_size=label_font_big,
        )
        label2 = MathTex(
            r"W_{\mathcal{Q}} \in \mathbb{R}^{d_v \times d_o}, b_{\mathcal{Q}} \in \mathbb{R}^{d_o}",
            font_size=label_font_small,
        )
        label1.next_to(arrow, UP, buff=0.2)
        label2.next_to(arrow, DOWN, buff=0.2)
        ...
        self.play(
            ...
            FadeOut(label1),
            FadeOut(label2),
            FadeOut(tensor_group_V),
            FadeOut(etichetta8),
            FadeOut(text12),
            run_time=1,
        )
        self.play(
            tensor_group_output.animate.shift(2 * LEFT),
            etichetta9.animate.shift(2 * LEFT),
            run_time=1,
        )
        self.wait(1)
